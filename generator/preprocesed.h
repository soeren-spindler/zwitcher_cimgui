...
struct ImBitArray
{
    ...
    bool            TestBit(int n) const        { n += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(661)), 0)) ); return ((Data[(n) >> 5] & ((ImU32)1 << ((n) & 31))) != 0); }
    void            SetBit(int n)               { n += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(662)), 0)) ); ImBitArraySetBit(Data, n); }
    void            ClearBit(int n)             { n += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(663)), 0)) ); ImBitArrayClearBit(Data, n); }
    void            SetBitRange(int n, int n2)  { n += OFFSET; n2 += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(664)), 0)) ); ImBitArraySetBitRange(Data, n, n2); } 
    bool            operator[](int n) const     { n += OFFSET; ((void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(665)), 0)) ); return ((Data[(n) >> 5] & ((ImU32)1 << ((n) & 31))) != 0); }
};
struct  ImBitVector
{
    ...
    bool            TestBit(int n) const        { ((void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(675)), 0)) ); return ((Storage.Data[(n) >> 5] & ((ImU32)1 << ((n) & 31))) != 0); }
    void            SetBit(int n)               { ((void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(676)), 0)) ); ImBitArraySetBit(Storage.Data, n); }
    void            ClearBit(int n)             { ((void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(677)), 0)) ); ImBitArrayClearBit(Storage.Data, n); }
};
template<typename T>
struct ImSpan
{
    ...
    inline T&           operator[](int i)           { T* p = Data + i; ((void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(698)), 0)) ); return *p; }
    inline const T&     operator[](int i) const     { const T* p = Data + i; ((void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(699)), 0)) ); return *p; }
    inline T*           begin()                     { return Data; }
    inline const T*     begin() const               { return Data; }
    inline T*           end()                       { return DataEnd; }
    inline const T*     end() const                 { return DataEnd; }
    inline int  index_from_ptr(const T* it) const   { ((void)( (!!(it >= Data && it < DataEnd)) || (_wassert(L"it >= Data && it < DataEnd", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(707)), 0)) ); const ptrdiff_t off = it - Data; return (int)off; }
};
template<int CHUNKS>
struct ImSpanAllocator
{
    ...
    inline void  Reserve(int n, size_t sz, int a=4) { ((void)( (!!(n == CurrIdx && n < CHUNKS)) || (_wassert(L"n == CurrIdx && n < CHUNKS", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(723)), 0)) ); CurrOff = (((CurrOff) + ((a) - 1)) & ~((a) - 1)); Offsets[n] = CurrOff; Sizes[n] = (int)sz; CurrIdx++; CurrOff += (int)sz; }
    inline int   GetArenaSizeInBytes()              { return CurrOff; }
    inline void  SetArenaBasePtr(void* base_ptr)    { BasePtr = (char*)base_ptr; }
    inline void* GetSpanPtrBegin(int n)             { ((void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(726)), 0)) ); return (void*)(BasePtr + Offsets[n]); }
    inline void* GetSpanPtrEnd(int n)               { ((void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(727)), 0)) ); return (void*)(BasePtr + Offsets[n] + Sizes[n]); }
    template<typename T>
...
struct ImStableVector
{
    ...
    inline T&           operator[](int i)           { ((void)( (!!(i >= 0 && i < Size)) || (_wassert(L"i >= 0 && i < Size", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(760)), 0)) ); return Blocks[i / BLOCKSIZE][i % BLOCKSIZE]; }
    inline const T&     operator[](int i) const     { ((void)( (!!(i >= 0 && i < Size)) || (_wassert(L"i >= 0 && i < Size", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(761)), 0)) ); return Blocks[i / BLOCKSIZE][i % BLOCKSIZE]; }
    inline T*           push_back(const T& v)       { int i = Size; ((void)( (!!(i >= 0)) || (_wassert(L"i >= 0", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(762)), 0)) ); if (Size == Capacity) reserve(Capacity + BLOCKSIZE); void* ptr = &Blocks[i / BLOCKSIZE][i % BLOCKSIZE]; memcpy(ptr, &v, sizeof(v)); Size++; return (T*)ptr; }
};
...
struct ImPool
{
    ...
    ImPoolIdx   GetIndex(const T* p) const          { ((void)( (!!(p >= Buf.Data && p < Buf.Data + Buf.Size)) || (_wassert(L"p >= Buf.Data && p < Buf.Data + Buf.Size", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(781)), 0)) ); return (ImPoolIdx)(p - Buf.Data); }
...
struct ImChunkStream
{
    ...
    T*      next_chunk(T* p)            { size_t HDR_SZ = 4; ((void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(813)), 0)) ); p = (T*)(void*)((char*)(void*)p + chunk_size(p)); if (p == (T*)(void*)((char*)end() + HDR_SZ)) return (T*)0; ((void)( (!!(p < end())) || (_wassert(L"p < end()", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(813)), 0)) ); return p; }
    int     chunk_size(const T* p)      { return ((const int*)p)[-1]; }
    T*      end()                       { return (T*)(void*)(Buf.Data + Buf.Size); }
    int     offset_from_ptr(const T* p) { ((void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(816)), 0)) ); const ptrdiff_t off = (const char*)p - Buf.Data; return (int)off; }
    T*      ptr_from_offset(int off)    { ((void)( (!!(off >= 4 && off < Buf.Size)) || (_wassert(L"off >= 4 && off < Buf.Size", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(817)), 0)) ); return (T*)(void*)(Buf.Data + off); }
...
struct ImGuiIDStackTool
{
    ...
    ImGuiIDStackTool()      { memset((void*)this, 0, sizeof(*this)); LastActiveFrame = -1; OptHexEncodeNonAsciiChars = true; CopyToClipboardLastTime = -3.402823466e+38F; }
};
...
namespace ImGui
{
    ...
    inline ImGuiKey         MouseButtonToKey(ImGuiMouseButton button)                   { ((void)( (!!(button >= 0 && button < ImGuiMouseButton_COUNT)) || (_wassert(L"button >= 0 && button < ImGuiMouseButton_COUNT", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(3641)), 0)) ); return (ImGuiKey)(ImGuiKey_MouseLeft + button); }
    ...
    inline ImGuiKeyOwnerData* GetKeyOwnerData(ImGuiContext* ctx, ImGuiKey key)          { if (key & ImGuiMod_Mask_) key = ConvertSingleModFlagToKey(key); ((void)( (!!(IsNamedKey(key))) || (_wassert(L"IsNamedKey(key)", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(3667)), 0)) ); return &ctx->KeysOwnerData[key - ImGuiKey_NamedKey_BEGIN]; }
...
inline ImFontAtlasRectId ImFontAtlasRectId_Make(int index_idx, int gen_idx)     { ((void)( (!!(index_idx >= 0 && index_idx <= (0x0007FFFF) && gen_idx <= ((0x3FF00000) >> (20)))) || (_wassert(L"index_idx >= 0 && index_idx <= (0x0007FFFF) && gen_idx <= ((0x3FF00000) >> (20))", L"F:\\Projects\\zwitcher\\zwitcher_cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(4134)), 0)) ); return (ImFontAtlasRectId)(index_idx | (gen_idx << (20))); }
struct ImFontAtlasRectEntry
{
    int                 TargetIndex : 20;   
